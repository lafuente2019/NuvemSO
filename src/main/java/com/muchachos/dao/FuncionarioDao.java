...
import com.muchachos.interfaces.FuncionarioInterface;
...
public class FuncionarioDao implements FuncionarioInterface {
    ...
    @Override
    public List<Funcionario> obterTodos() throws SQLException, ClassNotFoundException {
    ...
    @Override
    public Funcionario obterPorID(int cod) throws SQLException, ClassNotFoundException {
        Connection conexao = ConexaoDatabase.getConexao();
        PreparedStatement ps = conexao.prepareStatement("SELECT id, nome, Cpf, Rg, Sexo,"
                + " estado_civil , nascimento, Estado, Cidade, bairro, Logradouro, Numero,complemento, Telefone,"
