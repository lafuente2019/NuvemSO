    ...
    <body>
        ...
        <div id="barra-lateral" class="barra-lateral"><!--expandir/recolher, feito em jquery - usa o id #barra-lateral-->
            <ul><!--Colorir botões ao apertar, feito em jquery - usa a classe .item-linha-->
                ...
                <li><a class="item-linha" href="ConsultarCliente.jsp"><span class="fas fa-users mr-4"></span>Consulta de Cliente</a></li>
                <p>Marketing</p>
                ...
                <li><a class="item-linha" href="ConsultarCliente.jsp"><span class="fas fa-users mr-3"></span> Consulta de Cliente</a></li>
